...
const missing = [
  ...
  { name: 'Advanced match diagnostics', desc: 'Exact duplicate, wildcard-first, and fully covered bool/enum cases are diagnosed. Range overlap remains open.' },
    ...
    <div className="page">
      ...
      <SectionPanel title="Next priorities">
        <ol className="doc-list">
          ...
          <li>Add range-overlap match diagnostics.</li>
