...
const done = [
  ...
  { name: 'C backend', desc: 'C11 output validated with zig cc for current examples. Labeled loops, slices, defer, function pointers, range and identifier match patterns, and core match expressions are present; backend parity checks should keep expanding.' },
...
const missing = [
  ...
  { name: 'Backend semantic parity hardening', desc: 'Core conformance is green, but differential backend checks should expand. Side-effectful match scrutinees are supported in variable initializers; inline expression contexts and function-type aliases remain open.' },
